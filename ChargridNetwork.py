...
class ChargridNetwork(nn.Module):
    def __init__(self, HW, C, num_classes=5, num_anchors=4):
        ...
        self.ssd_d_block = add_block_d_or_e(C, C)
        ...
        self.bbrd_e_block = add_block_d_or_e(C, C)
        self.bbrd_f_block = add_block_f(C, C)
    ...
    def forward(self, x):
        ...
        print("bbrd after e block " + shape_as_string(bbrd_f_block_output.shape))
